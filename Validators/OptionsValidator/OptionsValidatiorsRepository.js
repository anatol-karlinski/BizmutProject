...
var OptionValidators = {
    ...
    StarSystemValidators: {
        ...
        multipleStarsChance: (optionsObject) =>
            (optionsObject['multipleStarsChance'] >= 0 && optionsObject['multipleStarsChance'] <= 1.0),
        maxStarCount: (optionsObject) =>
            (optionsObject['maxStarCount'] >= 0 && optionsObject['maxStarCount'] <= ProjectConstants.DEFAULT_MAX_STAR_COUNT_PER_SYSTEM),
    }
};
